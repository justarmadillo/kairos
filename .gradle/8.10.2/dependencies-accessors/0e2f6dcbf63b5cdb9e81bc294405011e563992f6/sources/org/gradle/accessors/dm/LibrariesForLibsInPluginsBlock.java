...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final RichLibraryAccessors laccForRichLibraryAccessors = new RichLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>rich</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public RichLibraryAccessors getRich() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForRichLibraryAccessors;
    }
    ...
    public static class CoilLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>video</b> with <b>io.coil-kt.coil3:coil-video</b> coordinates and
         * with version reference <b>coil</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class HiltNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hilt.ext</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class RichLibraryAccessors extends SubDependencyFactory {

        public RichLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>editor</b> with <b>com.mohamedrejeb.richeditor:richeditor-compose</b> coordinates and
         * with version reference <b>rich.editor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final RichVersionAccessors vaccForRichVersionAccessors = new RichVersionAccessors(providers, config);
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>accompanist</b> with value <b>0.37.0</b>
         * <p>
        ...
        /**
         * Version alias <b>room</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.rich</b>
         */
        public RichVersionAccessors getRich() {
            return vaccForRichVersionAccessors;
        }
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>34.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.services</b> with value <b>4.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class HiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>hilt.ext</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.compose</b> with value <b>2.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RichVersionAccessors extends VersionFactory  {

        public RichVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>rich.editor</b> with value <b>1.0.0-rc11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getEditor() { return getVersion("rich.editor"); }
